...
salaries.2014 <- runif(length(employees), min = 100, max = 5000)

# Create a vector of 2015 salaries that are typically higher than the 2014 salaires (use runif again)
salaries.2015 <- runif(length(employees), min = 300, max = 7000)
...
rownames(salaries) <- c("2014", "2015", "raise", "raise or not")
